angular
	...
	.controller('GroupController',['$rootScope', '$scope','$cookies', '$state','GroupDataOp','Access',
			...
			Access
				...
				.then(function(response){
					...
					if(data.authenticated){
						...
						if(data.principal.user.role.role == 'USER'){
							$state.go('home');
						}
					}
		...
		$scope.addMember = function(){
			...
			GroupDataOp
				.addMember($scope.newItem.groupEmployee,token)
				.then(function(response){
					console.log(response);
		...
		$scope.removeMember = function(selectedGroup,selectedMember){
			...
			GroupDataOp
			.removeMember(groupEmployee ,token)
			.then(function(response){
				console.log(response);
		...
		$scope.addAdmin = function(){
			...
			GroupDataOp
			.addAdmin($scope.newItem.groupEmployee,token)
			.then(function(response){
				console.log(response);
		...
		$scope.removeAdmin = function(selectedGroup,selectedAdmin){
			...
			GroupDataOp
			.removeAdmin(groupEmployee,token)
			.then(function(response){
				console.log(response);
		...
		$scope.loadMemberSelection = function(group){
			GroupDataOp
				.getAvailableMembers(group,token)
				.then(function(response){
					console.log(response);
		...
		$scope.loadAdminSelection = function(group){
			GroupDataOp
				.getAvailableAdmins(group,token)
				.then(function(response){
					console.log(response);
